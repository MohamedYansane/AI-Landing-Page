  ...
  return (
    <section className="py-20 md:py-24 ">
      <div className="container">
        ...
        >
          {/** on a two bg color rgb and  bgImage so pour fusioner les deux j'utilise le bg-blend-overlay */}
          {/**the mas image 50%_50%_at_50%_35% the first 50% is the size and the rest left && top   */}
          <div
